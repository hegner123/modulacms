...
func TestInsertFormat(t *testing.T) {
	...
	field := Field{RouteID: 4, Key: "link_url", Data: "https://example.com", Component: "link.html"}
	result, fieldsLength := formatSQLColumns(field)
...
func TestFieldQuery(t *testing.T) {
	...
	fields, err := getRouteFields(route, db)
	if err != nil {
		fmt.Printf("%s\n", err)
	}
    expected := Field{ID: 1, RouteID: 4, Author: "system", AuthorID: "0", Key: "link_url", Data: "https://example.com", DateCreated:"1730634309", DateModified:"1730634309",Component: "link.html", Tags: "", Parent: ""}
