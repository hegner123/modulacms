...
const fieldsTable string = `CREATE TABLE IF NOT EXISTS fields(id INTEGER PRIMARY KEY, routeId INTEGER NOT NULL, author TEXT, authorId TEXT, key TEXT, type TEXT, data TEXT, datecreated TEXT, datemodified TEXT, component TEXT, tags TEXT, parent TEXT);`
