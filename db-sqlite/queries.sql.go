...
func (q *Queries) DeleteSession(ctx context.Context, sessionID interface{}) error {
...
func (q *Queries) GetSession(ctx context.Context, sessionID interface{}) (Sessions, error) {
