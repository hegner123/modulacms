...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
        switch (name) {
          ...
          VALUES (?, ?, ?, ?, ?, ?)
        `);
                const result = stmt.run(args.title, args.content, args.category, args.tags || null, args.author, args.metadata || null);
                return {
                    content: [{
                            type: 'text',
          ...
          VALUES (?, ?, ?, ?, ?, ?)
        `);
                const result = stmt.run(args.decision, args.rationale, args.alternatives || null, args.impact || null, args.made_by, args.tags || null);
                return {
                    content: [{
                            type: 'text',
          ...
          VALUES (?, ?, ?, ?, ?, ?, ?, ?)
        `);
                const result = stmt.run(args.component_name, args.contract_json, args.design_image_path || null, args.generated_files || null, args.validation_status, args.validation_notes || null, args.agent_version || null, args.tags || null);
                return {
                    content: [{
                            type: 'text',
          ...
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `);
                const result = stmt.run(args.agent_name, args.task_description, args.input_summary || null, args.output_summary || null, args.success ? 1 : 0, args.error_message || null, args.execution_time_ms || null, args.artifacts || null, args.executed_by, args.tags || null);
                return {
                    content: [{
                            type: 'text',
          ...
          VALUES (?, ?, ?, ?, ?, ?, ?)
        `);
                const result = stmt.run(args.title, args.description, args.workaround || null, args.severity || 'medium', args.affected_components || null, args.reported_by, args.tags || null);
                return {
                    content: [{
                            type: 'text',
          ...
          VALUES (?, ?, ?, ?, ?, ?, ?, ?)
        `);
                const result = stmt.run(args.title, args.description, args.example_code || null, args.context || null, args.category, args.learned_from || null, args.added_by, args.tags || null);
                return {
                    content: [{
                            type: 'text',
          ...
          VALUES (?, ?, ?, ?, ?, ?, ?)
        `);
                const result = stmt.run(args.client_name, args.customization_type, args.description, args.implementation_notes || null, args.files_affected || null, args.shared_vs_custom, args.tags || null);
                return {
                    content: [{
                            type: 'text',
          ...
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
        `);
                const result = stmt.run(args.pattern_name, args.description, args.use_cases || null, args.example_implementation || null, args.pros || null, args.cons || null, args.related_patterns || null, args.category, args.tags || null);
                return {
                    content: [{
                            type: 'text',
