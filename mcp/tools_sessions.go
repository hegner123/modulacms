...
func registerSessionTools(srv *server.MCPServer, client *modulacms.Client) {
	srv.AddTool(
...
func handleListSessions(client *modulacms.Client) server.ToolHandlerFunc {
...
func handleGetSession(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		id, err := req.RequireString("id")
		if err != nil {
			return mcp.NewToolResultError("id is required"), nil
		}
		result, err := client.Sessions.Get(ctx, modulacms.SessionID(id))
		if err != nil {
			return errResult(err), nil
		}
		return jsonResult(result)
...
func handleUpdateSession(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		id, err := req.RequireString("id")
		if err != nil {
			return mcp.NewToolResultError("id is required"), nil
		}
		params := modulacms.UpdateSessionParams{
			SessionID:   modulacms.SessionID(id),
			UserID:      optionalIDPtr[modulacms.UserID](req, "user_id"),
			ExpiresAt:   modulacms.Timestamp(req.GetString("expires_at", "")),
...
func handleDeleteSession(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		id, err := req.RequireString("id")
		if err != nil {
			return mcp.NewToolResultError("id is required"), nil
		}
		err = client.Sessions.Remove(ctx, modulacms.SessionID(id))
		if err != nil {
			return errResult(err), nil
		}
