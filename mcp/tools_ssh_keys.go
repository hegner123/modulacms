...
func registerSSHKeyTools(srv *server.MCPServer, client *modulacms.Client) {
	srv.AddTool(
...
func handleListSSHKeys(client *modulacms.Client) server.ToolHandlerFunc {
...
func handleCreateSSHKey(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		params := modulacms.CreateSSHKeyParams{
			PublicKey: publicKey,
			Label:     label,
		}
...
func handleDeleteSSHKey(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		id, err := req.RequireString("id")
		if err != nil {
			return mcp.NewToolResultError("id is required"), nil
		}
		err = client.SSHKeys.Delete(ctx, modulacms.UserSshKeyID(id))
		if err != nil {
			return errResult(err), nil
		}
