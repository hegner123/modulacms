...
func registerPluginTools(srv *server.MCPServer, client *modulacms.Client) {
	srv.AddTool(
...
func handleListPlugins(client *modulacms.Client) server.ToolHandlerFunc {
...
func handleGetPlugin(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func handleReloadPlugin(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		name, err := req.RequireString("name")
		if err != nil {
			return mcp.NewToolResultError("name is required"), nil
...
func handleEnablePlugin(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		name, err := req.RequireString("name")
		if err != nil {
			return mcp.NewToolResultError("name is required"), nil
...
func handleDisablePlugin(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		name, err := req.RequireString("name")
		if err != nil {
			return mcp.NewToolResultError("name is required"), nil
...
func handlePluginCleanupDryRun(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func handlePluginCleanupDrop(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		params := modulacms.CleanupDropParams{
			Confirm: confirm,
			Tables:  tables,
		}
...
func handleListPluginRoutes(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func parseRouteApprovalItems(req mcp.CallToolRequest) ([]modulacms.RouteApprovalItem, error) {
	args := req.GetArguments()
	raw, ok := args["routes"]
	if !ok {
		return nil, nil
	...
	var items []modulacms.RouteApprovalItem
...
func handleApprovePluginRoutes(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func handleRevokePluginRoutes(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		routes, err := parseRouteApprovalItems(req)
		if err != nil {
			return mcp.NewToolResultError("invalid routes: " + err.Error()), nil
...
func handleListPluginHooks(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func parseHookApprovalItems(req mcp.CallToolRequest) ([]modulacms.HookApprovalItem, error) {
	args := req.GetArguments()
	raw, ok := args["hooks"]
	if !ok {
		return nil, nil
	...
	var items []modulacms.HookApprovalItem
	if err := json.Unmarshal(b, &items); err != nil {
		return nil, err
	}
	return items, nil
...
func handleApprovePluginHooks(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func handleRevokePluginHooks(client *modulacms.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		hooks, err := parseHookApprovalItems(req)
		if err != nil {
			return mcp.NewToolResultError("invalid hooks: " + err.Error()), nil
