var BlockEditorModule = (() => {
  ...
  __export(index_exports, {
    BLOCK_TYPE_CONFIG: () => BLOCK_TYPE_CONFIG,
    MAX_DEPTH: () => MAX_DEPTH,
    addBlock: () => addBlock,
    addBlockFromDatatype: () => addBlockFromDatatype,
    collectDescendants: () => collectDescendants,
    createState: () => createState,
    duplicateBlock: () => duplicateBlock,
    findLastSibling: () => findLastSibling,
    generateId: () => generateId,
    getBlockTraversalOrder: () => getBlockTraversalOrder,
    getChildren: () => getChildren,
    getDepth: () => getDepth,
    getDescendantCount: () => getDescendantCount,
    getRootList: () => getRootList,
    getTypeConfig: () => getTypeConfig,
    indentBlock: () => indentBlock,
    insertAfter: () => insertAfter,
    insertAsFirstChild: () => insertAsFirstChild,
    insertAsLastChild: () => insertAsLastChild,
