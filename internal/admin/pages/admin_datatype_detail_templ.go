...
func AdminDatatypeDetailContent(dt db.AdminDatatypes, linkedFields []db.AdminFields, allDatatypes []db.AdminDatatypes, csrfToken string, fieldTypes []db.AdminFieldTypes) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<!-- Page heading --><div class=\"border-b border-white/10 pb-5\"><div><a href=\"/admin/admin-datatypes\" hx-get=\"/admin/admin-datatypes\" hx-target=\"#main-content\" hx-push-url=\"true\" class=\"text-sm font-medium text-gray-400 hover:text-white\">&larr; Back to Admin Datatypes</a></div><div class=\"mt-3 md:flex md:items-center md:justify-between\"><div class=\"min-w-0 flex-1\"><div class=\"flex items-center gap-x-3\"><h2 class=\"text-2xl/7 font-bold text-white sm:truncate sm:text-3xl sm:tracking-tight\">")
		if templ_7745c5c3_Err != nil {
...
func AdminDatatypeAddFieldDialog(datatypeID string, csrfToken string, fieldTypes []db.AdminFieldTypes, validations []db.AdminValidation) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context
		if templ_7745c5c3_CtxErr := ctx.Err(); templ_7745c5c3_CtxErr != nil {
			return templ_7745c5c3_CtxErr
		...
		templ_7745c5c3_Err = partials.AdminDatatypeCreateFieldForm(datatypeID, "", "", "", "", "", "", nil, csrfToken, fieldTypes, validations).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func AdminDatatypeDetail(layout layouts.AdminData, dt db.AdminDatatypes, linkedFields []db.AdminFields, allDatatypes []db.AdminDatatypes, csrfToken string, fieldTypes []db.AdminFieldTypes, validations []db.AdminValidation) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context
		if templ_7745c5c3_CtxErr := ctx.Err(); templ_7745c5c3_CtxErr != nil {
			return templ_7745c5c3_CtxErr
		...
		templ_7745c5c3_Var11 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = AdminDatatypeDetailContent(dt, linkedFields, allDatatypes, csrfToken, fieldTypes).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		})
		templ_7745c5c3_Err = layouts.Admin(layout.WithDialogs(AdminDatatypeAddFieldDialog(dt.AdminDatatypeID.String(), csrfToken, fieldTypes, validations))).Render(templ.WithChildren(ctx, templ_7745c5c3_Var11), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
