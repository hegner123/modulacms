-- hooks_publish_plugin: Tests M12 publish status transition hooks.
-- Registers before_publish and after_publish hooks on content_data
-- to verify that DetectStatusTransition fires them.

plugin_info = {
    name        = "hooks_publish_plugin",
    version     = "1.0.0",
    description = "Publish detection test plugin",
}
