		...
		Datatypes: map[string]DatatypeDef{
			...
			"page": {
				...
				FieldRefs: []FieldDef{
					...
					{Label: "OG Image", Type: types.FieldTypeMedia},
			...
			"post": {
				...
				FieldRefs: []FieldDef{
					...
					{Label: "Featured Image", Type: types.FieldTypeMedia},
					{Label: "Category", Type: types.FieldTypeSelect, Data: types.NewNullableString(`{"options":["uncategorized","news","tutorial","opinion","review","announcement"]}`)},
					{Label: "Tags", Type: types.FieldTypeText},
					{Label: "Publish Date", Type: types.FieldTypeDatetime},
					{Label: "Meta Title", Type: types.FieldTypeText},
					{Label: "Meta Description", Type: types.FieldTypeTextarea},
					{Label: "Published", Type: types.FieldTypeBoolean},
				},
			...
			"case_study": {
				...
				FieldRefs: []FieldDef{
					{Label: "Title", Type: types.FieldTypeText},
					{Label: "Slug", Type: types.FieldTypeSlug},
					{Label: "Company Name", Type: types.FieldTypeText},
					{Label: "Company Logo", Type: types.FieldTypeMedia},
					{Label: "Company URL", Type: types.FieldTypeURL},
					{Label: "Industry", Type: types.FieldTypeText},
					{Label: "Description", Type: types.FieldTypeTextarea},
					...
					{Label: "Testimonial", Type: types.FieldTypeTextarea},
					{Label: "Featured Image", Type: types.FieldTypeMedia},
					{Label: "Published", Type: types.FieldTypeBoolean},
				},
			},
			...
			"documentation": {
				...
				FieldRefs: []FieldDef{
					{Label: "Title", Type: types.FieldTypeText},
					{Label: "Slug", Type: types.FieldTypeSlug},
					{Label: "Chapter", Type: types.FieldTypeText},
					{Label: "Sort Order", Type: types.FieldTypeNumber},
					{Label: "Description", Type: types.FieldTypeTextarea},
					{Label: "Published", Type: types.FieldTypeBoolean},
				},
			},
