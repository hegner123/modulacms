...
const createAdminContentVersion = `-- name: CreateAdminContentVersion :exec
...
func (q *Queries) CreateAdminContentVersion(ctx context.Context, arg CreateAdminContentVersionParams) error {
	_, err := q.db.ExecContext(ctx, createAdminContentVersion,
...
const createAdminFieldType = `-- name: CreateAdminFieldType :exec
...
func (q *Queries) CreateAdminFieldType(ctx context.Context, arg CreateAdminFieldTypeParams) error {
	_, err := q.db.ExecContext(ctx, createAdminFieldType, arg.AdminFieldTypeID, arg.Type, arg.Label)
	return err
}
...
const createAdminMedia = `-- name: CreateAdminMedia :exec
...
func (q *Queries) CreateAdminMedia(ctx context.Context, arg CreateAdminMediaParams) error {
	_, err := q.db.ExecContext(ctx, createAdminMedia,
		arg.AdminMediaID,
		arg.Name,
		arg.DisplayName,
		arg.Alt,
...
const createAdminMediaFolder = `-- name: CreateAdminMediaFolder :exec
...
func (q *Queries) CreateAdminMediaFolder(ctx context.Context, arg CreateAdminMediaFolderParams) error {
	_, err := q.db.ExecContext(ctx, createAdminMediaFolder,
		arg.AdminFolderID,
		arg.Name,
		arg.ParentID,
		arg.DateCreated,
...
const createAdminValidation = `-- name: CreateAdminValidation :exec
...
func (q *Queries) CreateAdminValidation(ctx context.Context, arg CreateAdminValidationParams) error {
	_, err := q.db.ExecContext(ctx, createAdminValidation,
...
const createBackupSet = `-- name: CreateBackupSet :exec
...
// Backup Sets CRUD
func (q *Queries) CreateBackupSet(ctx context.Context, arg CreateBackupSetParams) error {
	_, err := q.db.ExecContext(ctx, createBackupSet,
		arg.BackupSetID,
		arg.DateCreated,
		arg.HlcTimestamp,
		arg.Status,
...
const createFieldType = `-- name: CreateFieldType :exec
...
func (q *Queries) CreateFieldType(ctx context.Context, arg CreateFieldTypeParams) error {
	_, err := q.db.ExecContext(ctx, createFieldType, arg.FieldTypeID, arg.Type, arg.Label)
	return err
}
...
func (q *Queries) CreateMediaFolder(ctx context.Context, arg CreateMediaFolderParams) error {
	_, err := q.db.ExecContext(ctx, createMediaFolder,
		arg.FolderID,
		arg.Name,
		arg.ParentID,
		arg.DateCreated,
...
const createValidation = `-- name: CreateValidation :exec
...
func (q *Queries) CreateValidation(ctx context.Context, arg CreateValidationParams) error {
	_, err := q.db.ExecContext(ctx, createValidation,
		arg.ValidationID,
		arg.Name,
		arg.Description,
		arg.Config,
