...
func (b *svcLocaleBackend) CreateLocale(ctx context.Context, params json.RawMessage) (json.RawMessage, error) {
	...
	result, err := b.svc.Locales.CreateLocale(ctx, AuditContextFromMCP(ctx), p)
	if err != nil {
		return nil, err
	}
	return json.Marshal(result)
...
func (b *svcLocaleBackend) UpdateLocale(ctx context.Context, params json.RawMessage) (json.RawMessage, error) {
	...
	result, err := b.svc.Locales.UpdateLocale(ctx, AuditContextFromMCP(ctx), p)
	if err != nil {
		return nil, err
	}
	return json.Marshal(result)
...
func (b *svcLocaleBackend) DeleteLocale(ctx context.Context, id string) error {
	return b.svc.Locales.DeleteLocale(ctx, AuditContextFromMCP(ctx), types.LocaleID(id))
}
...
func (b *svcLocaleBackend) CreateTranslation(ctx context.Context, contentDataID string, params json.RawMessage) (json.RawMessage, error) {
	...
	result, err := b.svc.Locales.CreateTranslation(ctx, ac, types.ContentID(contentDataID), p.Locale, ac.UserID)
	if err != nil {
		return nil, err
	}
	return json.Marshal(result)
...
func (b *svcLocaleBackend) AdminCreateTranslation(ctx context.Context, adminContentDataID string, params json.RawMessage) (json.RawMessage, error) {
	...
	ac := AuditContextFromMCP(ctx)
	result, err := b.svc.Locales.CreateAdminTranslation(ctx, ac, types.AdminContentID(adminContentDataID), p.Locale, ac.UserID)
	if err != nil {
		return nil, err
	}
	return json.Marshal(result)
