...
func handleAdminListDatatypeFields(client *modula.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		params := url.Values{}
...
func handleAdminGetDatatypeField(client *modula.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		id, err := req.RequireString("id")
		if err != nil {
			return mcp.NewToolResultError("id is required"), nil
		}
		result, err := client.AdminDatatypeFields.Get(ctx, modula.AdminDatatypeFieldID(id))
		if err != nil {
			return errResult(err), nil
		}
		return jsonResult(result)
...
func handleAdminCreateDatatypeField(client *modula.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		params := modula.CreateAdminDatatypeFieldParams{
			AdminDatatypeID: modula.AdminDatatypeID(dtID),
			AdminFieldID:    modula.AdminFieldID(fID),
		}
...
func handleAdminUpdateDatatypeField(client *modula.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		id, err := req.RequireString("id")
		if err != nil {
			return mcp.NewToolResultError("id is required"), nil
		...
		params := modula.UpdateAdminDatatypeFieldParams{
			ID:              modula.AdminDatatypeFieldID(id),
			AdminDatatypeID: modula.AdminDatatypeID(dtID),
			AdminFieldID:    modula.AdminFieldID(fID),
		}
...
func handleAdminDeleteDatatypeField(client *modula.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		id, err := req.RequireString("id")
		if err != nil {
			return mcp.NewToolResultError("id is required"), nil
		}
		err = client.AdminDatatypeFields.Delete(ctx, modula.AdminDatatypeFieldID(id))
		if err != nil {
			return errResult(err), nil
		}
		return mcp.NewToolResultText("deleted"), nil
