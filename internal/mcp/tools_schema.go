...
func handleListDatatypeFields(client *modula.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		params := url.Values{}
...
func handleLinkFieldToDatatype(client *modula.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		params := modula.CreateDatatypeFieldParams{
			DatatypeID: modula.DatatypeID(dtID),
...
func handleUnlinkFieldFromDatatype(client *modula.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		id, err := req.RequireString("id")
		if err != nil {
			return mcp.NewToolResultError("id is required"), nil
		}
		err = client.DatatypeFields.Delete(ctx, modula.DatatypeFieldID(id))
		if err != nil {
			return errResult(err), nil
		}
		return mcp.NewToolResultText("deleted"), nil
...
func handleGetDatatypeField(client *modula.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		id, err := req.RequireString("id")
		if err != nil {
			return mcp.NewToolResultError("id is required"), nil
		}
		result, err := client.DatatypeFields.Get(ctx, modula.DatatypeFieldID(id))
		if err != nil {
			return errResult(err), nil
		}
		return jsonResult(result)
...
func handleUpdateDatatypeField(client *modula.Client) server.ToolHandlerFunc {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		id, err := req.RequireString("id")
		if err != nil {
			return mcp.NewToolResultError("id is required"), nil
		...
		sortOrder := int64(req.GetFloat("sort_order", 0))
		params := modula.UpdateDatatypeFieldParams{
			ID:         modula.DatatypeFieldID(id),
			DatatypeID: modula.DatatypeID(dtID),
			FieldID:    modula.FieldID(fID),
			SortOrder:  sortOrder,
		}
