...
func (r *RemoteDriver) DeleteAdminContentVersion(_ context.Context, _ audited.AuditContext, _ types.AdminContentVersionID) error {
	return ErrNotSupported{Method: "DeleteAdminContentVersion"}
}

func (r *RemoteDriver) GetAdminContentVersion(_ types.AdminContentVersionID) (*db.AdminContentVersion, error) {
	return nil, ErrNotSupported{Method: "GetAdminContentVersion"}
}
...
func (r *RemoteDriver) ListAdminContentVersionsByContent(_ types.AdminContentID) (*[]db.AdminContentVersion, error) {
	return nil, ErrNotSupported{Method: "ListAdminContentVersionsByContent"}
}
...
func (r *RemoteDriver) DeleteContentVersion(_ context.Context, _ audited.AuditContext, _ types.ContentVersionID) error {
	return ErrNotSupported{Method: "DeleteContentVersion"}
}

func (r *RemoteDriver) GetContentVersion(_ types.ContentVersionID) (*db.ContentVersion, error) {
	return nil, ErrNotSupported{Method: "GetContentVersion"}
}
...
func (r *RemoteDriver) GetUserByEmail(email types.Email) (*db.Users, error) {
	...
	for i := range items {
		if string(items[i].Email) == string(email) {
			result := userToDb(&items[i])
			return &result, nil
		}
	}
	return nil, fmt.Errorf("remote: GetUserByEmail: not found: %s", string(email))
}
...
func (r *RemoteDriver) GetUserSshKeyByFingerprint(fingerprint string) (*db.UserSshKeys, error) {
	ctx := context.Background()
	// List all SSH keys and filter by fingerprint.
	items, err := r.client.SSHKeys.List(ctx)
	if err != nil {
	...
	return nil, fmt.Errorf("remote: GetUserSshKeyByFingerprint: not found: %s", fingerprint)
}
...
func (r *RemoteDriver) ListEnabledLocales() (*[]db.Locale, error) {
	...
	var result []db.Locale
	for i := range items {
		if items[i].IsEnabled {
			result = append(result, localeToDb(&items[i]))
		}
	}
	return &result, nil
}
