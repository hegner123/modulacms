...
func TestDatabase_CRUD_Media(t *testing.T) {
	...
	created, err := d.CreateMedia(ctx, ac, CreateMediaParams{
		Name:         sql.NullString{String: "test-image", Valid: true},
		DisplayName:  sql.NullString{String: "Test Image", Valid: true},
		Alt:          sql.NullString{String: "A test image", Valid: true},
		Caption:      sql.NullString{String: "Test caption", Valid: true},
		Description:  sql.NullString{String: "Test description", Valid: true},
		Class:        sql.NullString{String: "hero", Valid: true},
		...
		Srcset:       sql.NullString{String: "test-sm.jpg 480w, test-lg.jpg 1920w", Valid: true},
		AuthorID:     authorID,
		DateCreated:  now,
		DateModified: now,
	})
	...
	updateResult, err := d.UpdateMedia(ctx, ac, UpdateMediaParams{
		Name:         sql.NullString{String: "test-image-updated", Valid: true},
		DisplayName:  sql.NullString{String: "Updated Test Image", Valid: true},
		Alt:          sql.NullString{String: "An updated test image", Valid: true},
		Caption:      sql.NullString{String: "Updated caption", Valid: true},
		Description:  sql.NullString{String: "Updated description", Valid: true},
		Class:        sql.NullString{String: "banner", Valid: true},
		Mimetype:     sql.NullString{String: "image/png", Valid: true},
		Dimensions:   sql.NullString{String: "3840x2160", Valid: true},
		URL:          types.URL("https://example.com/test-updated.png"),
		Srcset:       sql.NullString{String: "test-updated-sm.png 480w", Valid: true},
		AuthorID:     authorID,
		DateCreated:  now,
...
func TestDatabase_CRUD_Media_GetMediaByName(t *testing.T) {
	...
	_, err := d.CreateMedia(ctx, ac, CreateMediaParams{
		Name:         sql.NullString{String: "lookup-by-name", Valid: true},
...
func TestDatabase_CRUD_Media_GetMediaByURL(t *testing.T) {
	...
	_, err := d.CreateMedia(ctx, ac, CreateMediaParams{
		Name:         sql.NullString{String: "url-lookup-media", Valid: true},
		DisplayName:  sql.NullString{},
		Alt:          sql.NullString{},
		Caption:      sql.NullString{},
		Description:  sql.NullString{},
