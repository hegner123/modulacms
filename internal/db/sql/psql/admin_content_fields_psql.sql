...
ALTER TABLE admin_content_fields
    OWNER TO modula_u;

CREATE INDEX admin_content_fields_admin_content_data_id_index
    ON admin_content_fields (admin_content_data_id);

CREATE INDEX admin_content_fields_admin_field_id_index
    ON admin_content_fields (admin_field_id);

CREATE INDEX admin_content_fields_admin_route_id_index
    ON admin_content_fields (admin_route_id);
