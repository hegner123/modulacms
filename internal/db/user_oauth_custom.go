...
// MapUserOauth converts a sqlc-generated SQLite type to the wrapper type.
...
// MapUserOauth converts a sqlc-generated MySQL type to the wrapper type.
...
// MapUserOauth converts a sqlc-generated PostgreSQL type to the wrapper type.
...
// CreateUserOauth creates a new user OAuth record (SQLite).
func (d Database) CreateUserOauth(ctx context.Context, ac audited.AuditContext, s CreateUserOauthParams) (*UserOauth, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("failed to create user oauth: %w", err)
	}
	r := d.MapUserOauth(result)
	return &r, nil
}

// UpdateUserOauth updates an existing user OAuth record (SQLite).
...
// DeleteUserOauth deletes a user OAuth record (SQLite).
...
// CreateUserOauth creates a new user OAuth record (MySQL).
...
// UpdateUserOauth updates an existing user OAuth record (MySQL).
...
// DeleteUserOauth deletes a user OAuth record (MySQL).
...
// CreateUserOauth creates a new user OAuth record (PostgreSQL).
...
// UpdateUserOauth updates an existing user OAuth record (PostgreSQL).
...
// DeleteUserOauth deletes a user OAuth record (PostgreSQL).
...
// NewUserOauthCmd is an audited command for creating a user OAuth record (SQLite).
...
// UpdateUserOauthCmd is an audited command for updating a user OAuth record (SQLite).
...
// DeleteUserOauthCmd is an audited command for deleting a user OAuth record (SQLite).
...
// NewUserOauthCmdMysql is an audited command for creating a user OAuth record (MySQL).
...
// UpdateUserOauthCmdMysql is an audited command for updating a user OAuth record (MySQL).
...
// DeleteUserOauthCmdMysql is an audited command for deleting a user OAuth record (MySQL).
...
// NewUserOauthCmdPsql is an audited command for creating a user OAuth record (PostgreSQL).
...
// UpdateUserOauthCmdPsql is an audited command for updating a user OAuth record (PostgreSQL).
...
// DeleteUserOauthCmdPsql is an audited command for deleting a user OAuth record (PostgreSQL).
