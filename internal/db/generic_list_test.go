...
func TestGenericHeaders_FirstColumnIsID(t *testing.T) {
	...
	tablesToCheck := []DBTable{
		...
		Datatype, Field, Field_types, User_oauth, Media_folder, Admin_media, Admin_media_folder,
...
func TestGenericHeaders_MatchesStringStructFields(t *testing.T) {
	...
	tableToStringStruct := map[DBTable]reflect.Type{
		...
		Admin_media:             reflect.TypeOf(StringAdminMedia{}),
		Admin_media_folder:      reflect.TypeOf(StringAdminMediaFolder{}),
