...
1. SQL schema/queries (`sql/schema/`)
2. `DbDriver` interface and wrapper implementations (`internal/db/`)
3. Handlers (`internal/router/`)
4. TUI screens (`internal/tui/`)
5. Admin panel (`internal/admin/`)
